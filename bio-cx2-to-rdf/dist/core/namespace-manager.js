 ...
 */
export function createNamespaceMap(cx2Context) {
 ...
 */
export function generatePrefixDeclarations(namespaces) {
    const lines = [];
 ...
 */
export function hasPrefix(uri, namespaces) {
 ...
 */
export function expandUri(prefixedUri, namespaces) {
 ...
 */
export function compactUri(fullUri, namespaces) {
