 ...
 */
export function getProcessTypeUri(indraType) {
    const mapping = getRdfMapping(indraType);
    return mapping.processType;
}
//# sourceMappingURL=indra-type-mapper.js.map