 ...
 */
const PREDICATE_PATTERNS: Record<string, string> = {
  'binds': 'Complex',
 ...
 */
export function parseIndraUrl(url: string): {
  subject?: string;
  object?: string;
  type?: string;
} | null {
 ...
 */
function extractEvidenceCount(html: string): number {
 ...
 */
function parseRelationshipText(text: string): {
  subject?: string;
  predicate?: string;
  object?: string;
  indraType?: string;
 ...
 */
export function parseRelationships(relationshipsHtml: string): ParsedRelationship[] {
 ...
 */
function inferPredicate(indraType: string): string {
 ...
 */
export function getTotalEvidenceCount(relationshipsHtml: string): number {
 ...
 */
export function extractIndraUrls(relationshipsHtml: string): string[] {
  const urls: string[] = [];
